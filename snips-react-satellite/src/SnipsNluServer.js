...
export default class SnipsNluServer   {
    ...
    constructor(props) {
        ...
        let eventFunctions = {
        // SESSION
            'hermes/nlu/query' : function(payload,session) {
                if (payload.siteId) {
            ...
            'hermes/nlu/partialQuery' : function(payload,session) {
        ...
        this.logger = this.props.logger ? this.props.logger : new SnipsLogger({logAudio:false,setLogData:this.setLogData , eventCallbackFunctions :eventFunctions});
